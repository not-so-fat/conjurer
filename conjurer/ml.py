...
def get_default_cv(ml_type, problem_type, scoring=None, search_type="random", param_dict=None):
    """
    ...
    """
    return ml_tuner.get_cv(ml_type, problem_type, scoring, search_type, param_dict)
